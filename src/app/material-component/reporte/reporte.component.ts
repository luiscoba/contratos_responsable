...
export class ReporteComponent implements OnInit {
  ...
  displayedColumns: string[] = ["nombrecomercial", "nombrerazonsocial", "ruc"];
  dataSource;
  /////////////////////
  ...
  generatePdf() {
    this.reporteService.getProveedor(this.idProveedorSeleccionado).subscribe(
